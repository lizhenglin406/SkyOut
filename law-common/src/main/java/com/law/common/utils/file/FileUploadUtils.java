package com.law.common.utils.file;
...
import com.law.common.exception.file.FileNameLengthLimitExceededException;
import com.law.common.exception.file.FileSizeLimitExceededException;
import com.law.common.exception.file.InvalidExtensionException;
import com.law.common.utils.DateUtils;
import com.law.common.utils.StringUtils;
import com.law.common.utils.uuid.IdUtils;
import com.law.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = LawOfficeConfig.getProfile();
    ...
    {
        int dirLastIndex = LawOfficeConfig.getProfile().length() + 1;
